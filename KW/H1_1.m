...
DATA_DIR_PATH = fullfile('D:\Belkin\Data\Belkin\H2');
...
figure()
n = 1:length(featP_L1);
ax(1) = subplot(211);plot(n,featP_L2(n));
featP_scanA = [zeros(1,70) featP_scanA_L2];
ax(2) = subplot(212);plot(n,featP_scanA(n));
linkaxes(ax,'x');