function [] = CrossVal(ProcessedData.TaggingInfo, ProcessedData.L1_TimeTicks, ProcessedData.L1_Real, ProcessedData.L1_Imag, start_TS, stop_TS)
...
%% Plot tagging info in plot versus samples
...
figure()
plot(n, featP(n), xmarkers2,ymarkers1,'r*'); hold on;
title('Real Power (W) and ON/OFF Device Category IDs');
