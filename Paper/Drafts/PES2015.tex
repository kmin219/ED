...
\begin{figure}[!t]	
	\centering
	\subfloat[Training]{\includegraphics[width=3.5in,height = 1.05in]{fig/exTrain.eps}
		\label{fig:event1ml}}
	\hfil
	\subfloat[Test]{\includegraphics[width=3.5in,height = 1.05in]{fig/exTestH2_1.eps}
		\label{fig:event2ml}}
...
\begin{figure}[!t]
	...
	\caption{Difference of two moving average windows to calculate averaged power difference time series.  The bottom plot shows the transient signature for appliance XXXXXXX.}
	\label{fig:maw}
\end{figure}
