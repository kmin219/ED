...
for i = [1:size(H1_4,1)]
    if(H1_4(i,1) == 1)
        on_start_idx = fgetindex(Windows_All_L1,H1_4(i,2),H1_4(i,3),H1_4(i,4));
        on_end_idx = fgetindex(Windows_All_L1,H1_4(i,5),H1_4(i,6),H1_4(i,7));
        ...
        off_start_idx = fgetindex(Windows_All_L1,H1_4(i,8),H1_4(i,9),H1_4(i,10));
        off_end_idx = fgetindex(Windows_All_L1,H1_4(i,11),H1_4(i,12),H1_4(i,13));
    ...
    if(H1_4(i,1) == 2)
        on_start_idx = fgetindex(Windows_All_L2,H1_4(i,2),H1_4(i,3),H1_4(i,4));
        on_end_idx = fgetindex(Windows_All_L2,H1_4(i,5),H1_4(i,6),H1_4(i,7));
        ...
        off_start_idx = fgetindex(Windows_All_L2,H1_4(i,8),H1_4(i,9),H1_4(i,10));
        off_end_idx = fgetindex(Windows_All_L2,H1_4(i,11),H1_4(i,12),H1_4(i,13));
     ...
     window_P{i}{4} = H1_4(i,14);  % on/off
     window_P{i}{5} = H1_4(i,15);  % P threshold
     
     window_Q{i}{4} = H1_4(i,14);  % on/off
     window_Q{i}{6} = H1_4(i,16);  % Q threshold
     
end

window_P_H1_4 = window_P;
window_Q_H1_4 = window_Q;
