...
for i = [1:size(H1_5,1)]
    if(H1_5(i,1) == 1)
        on_start_idx = fgetindex(Windows_All_L1,H1_5(i,2),H1_5(i,3),H1_5(i,4));
        on_end_idx = fgetindex(Windows_All_L1,H1_5(i,5),H1_5(i,6),H1_5(i,7));
        ...
        off_start_idx = fgetindex(Windows_All_L1,H1_5(i,8),H1_5(i,9),H1_5(i,10));
        off_end_idx = fgetindex(Windows_All_L1,H1_5(i,11),H1_5(i,12),H1_5(i,13));
    ...
    if(H1_5(i,1) == 2)
        on_start_idx = fgetindex(Windows_All_L2,H1_5(i,2),H1_5(i,3),H1_5(i,4));
        on_end_idx = fgetindex(Windows_All_L2,H1_5(i,5),H1_5(i,6),H1_5(i,7));
        ...
        off_start_idx = fgetindex(Windows_All_L2,H1_5(i,8),H1_5(i,9),H1_5(i,10));
        off_end_idx = fgetindex(Windows_All_L2,H1_5(i,11),H1_5(i,12),H1_5(i,13));
