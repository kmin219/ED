...
DATA_DIR_PATH = fullfile(path,'/Data/H1');
...
fname = fileList{6}; % ***** Note: We are only loading one of the files. This should be put in a loop as needed **
clear Buffer;
...
featP_L2 = ProcessedData.L1_Real(start_idx_L1:stop_idx_L1);  % truncate
