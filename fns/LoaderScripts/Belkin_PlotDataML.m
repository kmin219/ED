...
%     ProcessedData.HF = ProcessedData.HF(:, :);
%     ProcessedData.HF_TimeTicks = ProcessedData.HF_TimeTicks(:, :);
...
%         offset_on = 0;
%         line([ProcessedData.TaggingInfo{i,3} + offset_on, ProcessedData.TaggingInfo{i,3} + offset_on],[0,1000],'Color',[0 1 .5],'LineWidth',1);
%         %We add a little offset for display purposes to end marker since event could be +- 30
%         %seconds of the timestamp.
%         offset = 20;
%         line([ProcessedData.TaggingInfo{i,4} + offset,ProcessedData.TaggingInfo{i,4} + offset],[0,1000],'Color','r', 'LineWidth',1);    
