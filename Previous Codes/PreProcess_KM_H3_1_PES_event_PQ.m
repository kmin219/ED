...
%% Event Detection %%
temp = ProcessedData.L1_Imag(start_idx_L1:stop_idx_L1);  % truncate to temp
...
figure ()
plot(ProcessedData.L1_TimeTicks(start_idx_L1:stop_idx_L1), ProcessedData.L1_Imag(start_idx_L1:stop_idx_L1));
